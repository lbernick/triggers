...
func Create(logger *zap.SugaredLogger, rt json.RawMessage, triggerName, eventID, elName, elNamespace string, additionalLabels map[string]string, c discoveryclient.ServerResourcesInterface, dc dynamic.Interface) error {
	...
	data, err = addLabels(data, additionalLabels)
	if err != nil {
		return err
	}
