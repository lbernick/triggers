...
// controller reconciling v1beta1.ConcurrencyControl.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.ConcurrencyControl. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.ConcurrencyControl) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.ConcurrencyControl.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.ConcurrencyControl. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1beta1.ConcurrencyControl) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1beta1.ConcurrencyControl if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1beta1.ConcurrencyControl.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1beta1.ConcurrencyControl) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1beta1.ConcurrencyControl) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1beta1.ConcurrencyControl resources.
type reconcilerImpl struct {
	...
	Lister triggersv1beta1.ConcurrencyControlLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister triggersv1beta1.ConcurrencyControlLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.ConcurrencyControl) (*v1beta1.ConcurrencyControl, error) {
	...
	patcher := r.Client.TriggersV1beta1().ConcurrencyControls(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.ConcurrencyControl) (*v1beta1.ConcurrencyControl, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.ConcurrencyControl, reconcileEvent reconciler.Event) (*v1beta1.ConcurrencyControl, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
