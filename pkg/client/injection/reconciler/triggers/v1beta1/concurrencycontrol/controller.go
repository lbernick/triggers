...
import (
	...
	concurrencycontrol "github.com/tektoncd/triggers/pkg/client/injection/informers/triggers/v1beta1/concurrencycontrol"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "concurrencycontrols.triggers.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "triggers.tekton.dev.ConcurrencyControl"),
	)
