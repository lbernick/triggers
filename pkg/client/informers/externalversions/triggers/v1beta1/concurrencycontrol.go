...
type ConcurrencyControlInformer interface {
	...
	Lister() v1beta1.ConcurrencyControlLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TriggersV1beta1().ConcurrencyControls(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TriggersV1beta1().ConcurrencyControls(namespace).Watch(context.TODO(), options)
			},
		},
		&triggersv1beta1.ConcurrencyControl{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *concurrencyControlInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&triggersv1beta1.ConcurrencyControl{}, f.defaultInformer)
}

func (f *concurrencyControlInformer) Lister() v1beta1.ConcurrencyControlLister {
	return v1beta1.NewConcurrencyControlLister(f.Informer().GetIndexer())
}
